...
class AppColors {
  ...
  static const bgVeryLight = Color(0xFFF0F7FF);
  static const bgLight = Color(0xFFE0EFFF);
  static const blueSoft = Color(0xFFC2DEFF);
  static const blueLight = Color(0xFF9CC7FF);
  ...
  static const borderLight = Color(0xFFE3E8FF);
}